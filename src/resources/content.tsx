...
const social: Social = [
  ...
  },
  {
    name: "LinkedIn",
    icon: "linkedin",
    link: "https://www.linkedin.com/in/allen-jiang-4138/",
    essential: true,
  },
  {
    name: "Resume",
  ...
  images: [
    {
      ...
      caption: "At a hotel, overlooking the Qiandao Lake",
      orientation: "vertical",
    },
    {
      src: "/images/gallery/china_vertical_2.jpeg",
      alt: "china vertical 2",
      caption: "Nighttime in Yantaishan Commercial Block.",
      orientation: "vertical",
    },
    {
      src: "/images/gallery/china_vertical_3.jpeg",
      alt: "china vertical 3",
      caption: "A small palace/museum in the city of Minhou, Fuzhou.",
      orientation: "vertical",
    },
    {
      src: "/images/gallery/china_vertical_4.jpeg",
      alt: "china vertical 4",
      caption: "The view before I got on a bullet train from Shanghai to Hangzhou.",
      orientation: "vertical",
    },
    {
      src: "/images/gallery/china_vertical_5.jpeg",
      alt: "china vertical 5",
      caption: "Another view of Yantaishan. It was around 3 AM, and not quite empty yet.",
      orientation: "vertical",
    },
    {
      src: "/images/gallery/china_vertical_6.jpeg",
      alt: "china vertical 6",
      caption: "Somewhere, home, in China.",
      orientation: "vertical",
    },
    {
    ...
    },
    {
      ...
      caption: "Nighttime at Qiandao Lake.",
      orientation: "vertical",
    },
    {
      src: "/images/gallery/china_vertical_9.jpeg",
      alt: "china vertical 9",
      caption: "First look after stepping out into Shanghai's cityscape from the subway.",
      orientation: "vertical",
    },
    {
      src: "/images/gallery/ny_vertical_1.jpeg",
      alt: "new york vertical 1",
      caption: "A shot of Ithaca Falls! This view does not even look like it was in a New York.",
      orientation: "vertical",
    },
    {
      src: "/images/gallery/ny_vertical_2.jpeg",
      alt: "new york vertical 2",
      caption: "Outside of Uris Library at Cornell University.",
      orientation: "vertical",
    },
    {
      src: "/images/gallery/vegas_horizontal_1.jpeg",
      alt: "vegas horizontal 1",
      caption: "The Conservatory at the Bellagio. ",
      orientation: "horizontal",
    },
    {
      src: "/images/gallery/vegas_horizontal_2.jpeg",
      alt: "vegas horizontal 2",
      caption: "I wanted to take a picture of Vegas without the Vegas feel. This really just looks like anywhere.",
      orientation: "horizontal",
    },
    {
      src: "/images/gallery/vegas_vertical_1.jpeg",
      alt: "vegas vertical 1",
      caption: "Little Paris in Vegas!",
      orientation: "vertical",
    },
    {
      src: "/images/gallery/vegas_vertical_2.jpeg",
      alt: "vegas vertical 2",
      caption: "A shot of Planet Hollywood in Las Vegas!",
      orientation: "vertical",
    },
    {
      src: "/images/gallery/vegas_vertical_3_wynn.jpeg",
      alt: "vegas vertical 3 wynn",
      caption: "Wynn in Las Vegas had a cool waterfall feature.",
      orientation: "vertical",
    },
    {
      src: "/images/gallery/vegas_vertical_4_theball.jpeg",
      alt: "vegas vertical 4 the ball",
      caption: "The Sphere in Las Vegas. Unfortunately, he blinked.",
      orientation: "vertical",
    },
    {
      src: "/images/gallery/vegas_vertical_5.jpeg",
      alt: "vegas vertical 5",
      caption: "A shot outside one of the casinos in Las Vegas. The atmosphere in the lobby gave away nothing of what was happening within.",
      orientation: "vertical",
    },
    {
      src: "/images/gallery/vegas_vertical_6.jpeg",
      alt: "vegas vertical 6",
      caption: "One of the hotels at Vegas, called Bellagio. Unfortunately, the fountain show was not happening at the time, but the hotel itself was still pretty nice.",
      orientation: "vertical",
    },
    {
      src: "/images/gallery/vegas_vertical_7_fremont.jpeg",
      alt: "vegas vertical 7 fremont",
      caption: "Fremont Street in Las Vegas. The vibrant lights and bustling atmosphere was almost overwhelming.",
      orientation: "vertical",
    },
  ],
};
